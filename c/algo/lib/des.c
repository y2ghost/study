...
typedef enum des_eord_t_ {encipher, decipher} des_eord_t;
...
static int des_main(const unsigned char *source, unsigned char *target, const
    unsigned char *key, des_eord_t direction)
{
    static unsigned char subkeys[16][7] = {{0,}};
    unsigned char temp[8] = {'\0'};
    unsigned char lkey[4] = {'\0'};
    unsigned char rkey[4] = {'\0'};
    unsigned char lblk[6] = {'\0'};
    unsigned char rblk[6] = {'\0'};
    unsigned char fblk[6] = {'\0'};
    unsigned char xblk[6] = {'\0'};
