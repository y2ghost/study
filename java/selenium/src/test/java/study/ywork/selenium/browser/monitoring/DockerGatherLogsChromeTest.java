...
@Ignore
public class DockerGatherLogsChromeTest {
    static final Logger log = getLogger(lookup().lookupClass());
    private WebDriverManager wdm = WebDriverManager.chromedriver().browserInDocker().watch();
    ...
    @Test
    void testDockerGatherLogsChrome() {
