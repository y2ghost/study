...
import study.ywork.jpa.model.fetching.eagerjoin.Bid;
import study.ywork.jpa.model.fetching.eagerjoin.Item;
import study.ywork.jpa.model.fetching.eagerjoin.User;
...
public class EagerJoinTest extends JpaManager {
    @Override
    public void configurePersistenceUnit() {
        configurePersistenceUnit("fetchingEagerJoin");
    }
