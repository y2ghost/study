...
import study.ywork.jpa.model.collections.sortedmapofstrings.Item;
...
public class SortedMapOfStringTest extends JpaManager {
    @Override
    public void configurePersistenceUnit() {
        configurePersistenceUnit("sortedMapOfString");
    }
