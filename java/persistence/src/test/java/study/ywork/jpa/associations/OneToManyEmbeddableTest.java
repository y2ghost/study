...
import study.ywork.jpa.model.associations.onetomany.embeddable.Address;
import study.ywork.jpa.model.associations.onetomany.embeddable.Shipment;
import study.ywork.jpa.model.associations.onetomany.embeddable.User;
...
public class OneToManyEmbeddableTest extends JpaManager {
    @Override
    public void configurePersistenceUnit() {
        configurePersistenceUnit("oneToManyEmbeddable");
    }
