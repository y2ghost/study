...
import study.ywork.jpa.model.associations.onetomany.bidirectional.Bid;
import study.ywork.jpa.model.associations.onetomany.bidirectional.Item;
...
public class OneToManyBidirectionalTest extends JpaManager {
    @Override
    public void configurePersistenceUnit() {
        configurePersistenceUnit("oneToManyBidirectional");
    }
