...
public class Sax2Test {
    private static final String FEAT_NSP = "http://xml.org/sax/features/namespace-prefixes";
    private static final String FEAT_VAL = "http://xml.org/sax/features/validation";
    private static final String PROP_LH = "http://xml.org/sax/properties/lexical-handler";

    public static void main(String[] args) {
        if (args.length < 1 || args.length > 2) {
            err.println("usage: java Sax2Test xmlfile [v]");
            return;
        }
        try {
