...
public class AutoGenerateProcessor extends AbstractProcessor {
    ...
    private void generateClass(AutoImplement autoImplement, Element element) throws Exception {
        ...
        implClass.addConstructor(builder == null ? "public" : "private", fieldInfo.getMandatoryFields());
        if (builder != null) {
        ...
        if (builder != null) {
            ...
            JMethod buildMethod = new JMethod().defineSignature("public", false, autoImplement.as()).name("build");
