...
// MessageToMessageCodec集成了编解码器
@Sharable
public class MyWebSocketConvertHandler extends MessageToMessageCodec<WebSocketFrame,
    MyWebSocketConvertHandler.MyWebSocketFrame> {
    @Override
    protected void encode(ChannelHandlerContext ctx,
        MyWebSocketConvertHandler.MyWebSocketFrame msg, List<Object> out)
        throws Exception {
